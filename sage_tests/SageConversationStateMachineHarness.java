...
public final class SageConversationStateMachineHarness {
    ...
    public static void main(String[] args) {
        ...
        require(!media.executable
                        && media.source == SageConversationStateMachine.SpeechSource.DEVICE_MEDIA,
        ...
        System.out.println("PASS: wake debounce, media rejection, echo rejection, stale callbacks");
        System.out.println("PASS: one bounded retry and conversation continuation");
    }
}
