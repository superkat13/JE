...
checks = {
    ...
    "alternate candidates are diagnosed": 'SageOwnerExperience.recordCandidates(SageVoiceService.this, "final"' in voice,
    "diagnostics use service context": 'SageOwnerExperience.recordCandidates(this, "final"' not in voice,
