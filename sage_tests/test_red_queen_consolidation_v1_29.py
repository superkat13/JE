...
checks = {
    ...
    "workspace has Device Authority hub": 'functional(root, "Device Authority"' in workspace,
    "workspace preserves Boot Evidence": 'functional(root, "Boot Evidence"' in workspace,
    "workspace preserves Dell Evidence Import": 'functional(root, "Dell Evidence Import"' in workspace,
