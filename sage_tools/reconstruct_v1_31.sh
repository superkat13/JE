...
python3 sage_patches/sherpa_mic_ab_v1_31.py "$OUTPUT"
python3 sage_patches/sherpa_mic_truth_v1_31.py "$OUTPUT"
python3 sage_patches/sherpa_mic_handoff_v1_31.py "$OUTPUT"
python3 sage_patches/release_v1_31.py "$OUTPUT"
echo "Reconstructed Sage Commander 1.31.0 (44) with Brain presence, response-route telemetry, natural Voice Studio, Speech Lab, verified sherpa engine/model management, isolated local sherpa microphone A/B telemetry with automatic listener handoff, and all 1.30.1 continuity preserved in $OUTPUT"
