...
if len(sys.argv) != 2:
    raise SystemExit("usage: normalize_forge_activity_v1_30_1.py <reconstructed-source>")
...
print("Normalized the inherited Forge system-info button anchor for the additive 1.30.1 patch")
